        ...
        <PublicLayout>
            ...
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-12">
                <div className="container mx-auto px-4">
                    <h1 className="text-4xl font-bold mb-4">Book a Helper</h1>
                    <p className="text-xl text-white/90">Fill in the form below to book your trusted helper</p>
                </div>
            </div>
                    ...
                    <form onSubmit={submit} className="bg-white rounded-lg shadow-md p-8">
                        ...
                        <div className="mt-8 flex gap-4">
                            <button
                                type="submit"
                                disabled={processing}
                                className="flex-1 bg-purple-600 text-white px-6 py-3 rounded-lg hover:bg-purple-700 transition duration-300 font-semibold"
                            >
