        ...
        <PublicLayout>
            ...
            <div className="container mx-auto px-4 py-12 dark:bg-gray-900">
                <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
                    <h2 className="text-2xl font-bold mb-4 dark:text-white">Data Collection</h2>
                    ...
                    <h2 className="text-2xl font-bold mb-4 dark:text-white">Data Usage</h2>
                    <p className="text-gray-700 dark:text-gray-300 mb-6">
                    ...
                    <h2 className="text-2xl font-bold mb-4 dark:text-white">Your Rights</h2>
                    <p className="text-gray-700 dark:text-gray-300 mb-6">
