    ...
    if (error || !business) {
        return (
            <PublicLayout>
                ...
                <div className="container mx-auto px-4 py-12 text-center">
                    <p className="text-red-600 dark:text-red-400">{error || "Business not found"}</p>
                </div>
            </PublicLayout>
        );
    }
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6 order-2 lg:order-1">
                            ...
                            <div className="space-y-4">
                                {business.phone && (
                                    <div>
                                        ...
                                        <p className="font-semibold text-gray-900 dark:text-white">{business.phone}</p>
                                    </div>
                                )}
                                {business.address && (
                                    <div>
                                        <p className="text-sm text-gray-600 dark:text-gray-400">Address</p>
                                        <p className="font-semibold text-gray-900 dark:text-white">{business.address}</p>
                                    </div>
                                )}
                                {business.city && (
                                    <div>
                        ...
                        {/* Stats Card */}
                        <div className="bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20 rounded-lg shadow-md p-6">
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Business Stats</h3>
                            <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                    <span className="text-gray-600 dark:text-gray-400">Total Services</span>
                                    <span className="font-bold text-primary-600 dark:text-primary-400 text-lg">{serviceListings.length}</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <span className="text-gray-600 dark:text-gray-400">Active Workers</span>
                                    <span className="font-bold text-primary-600 dark:text-primary-400 text-lg">{workers.length}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        {business.phone && (
                            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Contact Business</h3>
                                                ...
                                                <div className="flex items-center gap-4 mb-4">
                                                    {worker.photo ? (
                                                        <img
                                                            ...
                                                            alt={worker.name}
                                                            className="w-16 h-16 rounded-full object-cover border-2 border-primary-300 dark:border-primary-700"
                                                        />
                                                    ) : (
                                                        <div className="w-16 h-16 rounded-full bg-primary-300 dark:bg-primary-700 flex items-center justify-center text-2xl">
                                                            👤
                                                        </div>
                                                    )}
                                                    <div className="flex-1">
