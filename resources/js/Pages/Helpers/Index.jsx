    ...
    return (
        <PublicLayout>
            ...
            <section className="relative bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-950 text-white overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 py-10 md:py-12 relative z-10 w-full text-center">
                    <div className="max-w-2xl mx-auto">
                        <h1 className="text-3xl md:text-4xl font-bold mb-3 leading-tight">Find Helpers</h1>
                        <p className="text-lg text-indigo-100/90 dark:text-indigo-200/90 leading-relaxed">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mb-12">
                            ...
                            <form onSubmit={handleBookingSubmit}>
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 font-bold uppercase tracking-wide">Phone *</label>
                                        <div className="flex items-center gap-2">
                                            ...
                                            <input
                                                ...
                                                className="flex-1 rounded-r-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 py-2.5 px-4"
                                ...
                                {helpers.data.map((helper) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer flex flex-col"
                                        >
