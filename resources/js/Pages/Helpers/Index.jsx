                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="relative h-48 overflow-hidden bg-gradient-to-br from-primary-400 to-primary-600">
                                            {isBusiness ? (
                                                <div className="flex items-center justify-center h-full text-6xl text-white">🏢</div>
                                            ) : helper.photo ? (
                                                <img 
                                            ...
                                            {!isBusiness && helper.verification_status === "verified" && (
                                                <div className="absolute top-3 left-3 bg-green-500 text-white rounded-full px-2 py-1 flex items-center gap-1">
                                        ...
                                        <div className="p-5">
                                            ...
                                            {/* Locations from Service Listings */}
                                            ...
                                            <div className="flex items-center gap-4 text-sm text-gray-600 mb-3">
                                                ...
                                                {helper.total_reviews > 0 && (
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        <span>{helper.total_reviews} {helper.total_reviews === 1 ? "review" : "reviews"}</span>
                                                    </div>
                                                )}
                                            </div>
                                                ...
                                                <div className="mt-4 pt-3 border-t border-gray-200">
                                                    <div className="flex items-center justify-center gap-2">
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex items-center justify-center w-10 h-10 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-all duration-200 shadow-sm hover:shadow-md"
                                                            title="Send Message"
                                                        >
                                                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
